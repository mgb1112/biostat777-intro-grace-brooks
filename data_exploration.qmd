...
With this data analysis, I intend to explore the offensive statistics of MLB teams in 2023. Specifically, I want to dive into the "3 True Outcomes" which are the offensive outcomes that are not reliant on the defense (strikeout, walk, and home run). On top of these, I would like to look at hits and the various breakdowns of numbers of singles, double, triples, and home runs throughout leagues and teams. This data analysis would be helpful for baseball statisticians, avid baseball fans, and potentily the MLB (although I'm sure they have their own people doing more in-depth analysese than this. The data that I am using for this sample data analysis is from the "Lahman" R package. This R package stores tables from the 'Sean Lahman Baseball Database'. Specifically, I focused on the "Teams" table, which houses yearly stats and standings for MLB teams.
